...
[GameRequest("/inventory/equipment/awakening")]
public class AwakeningEquipment : LobbyMessage
{
    protected override async Task HandleAsync()
    {
        ...
        NetEquipmentAwakeningOption awakeningOption = new()
        {
            Option1Lock = false,
    ...
    private int GenerateNewOptionIdInit(List<int> excludedStateEffectIds, int level)
    {
        ...
        HashSet<int> excludedEffectGroupIds = new();
    ...
    {
        List<EffectGroupWithWeight> weightedEffectGroups = new();
